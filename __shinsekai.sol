...
contract ShinsekaiToken is ERC20, Ownable {
    ...
    constructor() ERC20("Shinsekai", "SHIN") {
        ...
        devFeesAddress1 = payable(msg.sender);
    ...
    function setSwappingThreshold(
        uint256 swappingThreshold_
    ) external onlyOwner {
    ...
    function setMarketingFeesAddress(
        address marketingFeesAddress_
    ) external onlyOwner {
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && automatedMarketMakerPairs[to]) {
            ...
            uint256 threshold = (balanceOf(uniswapPair) * swappingThreshold) / 10000;
    ...
    function takeFee(uint256 tokenAmount) private lockTheSwap {
        ...
        uint ethForDev1 = (ethForDev * buyDevTax1) / (buyDevTax1 + buyDevTax2);
        uint ethForDev2 = ethForDev - ethForDev1;
    ...
    function getWalletStatus(address _address) external view returns (LimitedWallet memory){
